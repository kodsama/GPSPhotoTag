...
const Map<String, String> kEnglishStrings = {
  ...
  'mcp_transport_value': 'TCP, one JSON-RPC message per line',
  'mcp_auth': 'Authentication',
  'mcp_auth_none': 'None, loopback only',
  'mcp_copy_config': 'Copy config',
  'mcp_config_copied': 'Connection config copied',
  'mcp_restart': 'Restart',
  'mcp_offline_hint': 'Not listening. Restart to try 8787-8796 again.',
  'mcp_close': 'Close',
