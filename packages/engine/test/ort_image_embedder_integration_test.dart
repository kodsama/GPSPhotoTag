...
void main() {
  ...
  group('OrtImageEmbedder (native ORT inference)', () {
    ...
    test('two different photos are less similar than a self-match', () async {
      ...
      final dog = img.decodeImage(File(_fixture('dog.jpg')).readAsBytesSync())!;
    ...
    test('a real lib but a corrupt model → caught, embedder unavailable', () {
      ...
      File(p.join(tmp.path, kEmbeddingModelFileName))
