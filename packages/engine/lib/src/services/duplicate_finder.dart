...
/// The Smart (embedding) similarity of [a] and [b] in 0..1 (1 = identical):
...
class HashedFile {
  ...
  /// The L2-normalized on-device embedding vector used by the Smart metric
...
///   [embeddingSimilarity] (cosine over the on-device embedding). Smart is
